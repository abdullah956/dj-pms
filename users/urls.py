...
from .views import (
    UserRegisterView , UserLoginView , LandlordDashboardView , TenantDashboardView , UserLogoutView , CustomPasswordResetView , CustomPasswordResetConfirmView ,  CustomPasswordResetCompleteView
)
